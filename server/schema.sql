...
INSERT INTO menus (name, price, category, stock, description) VALUES
('아메리카노', 3000, 'Coffee', 100, '진한 에스프레소와 물의 깔끔한 조화'),
('카페라떼', 3500, 'Coffee', 50, '부드러운 우유와 에스프레소가 만난 고소한 맛'),
('카푸치노', 3800, 'Coffee', 30, '풍부한 우유 거품과 시나몬 가루의 완벽한 조화'),
('바닐라라떼', 4000, 'Coffee', 40, '달콤한 바닐라 시럽이 더해진 부드러운 라떼'),
('에스프레소', 2500, 'Coffee', 20, '커피의 본연의 맛을 가장 진하게 느낄 수 있는 기본 추출 커피');
